# Generated by Django 3.1 on 2021-03-04 21:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Nombre del cupon')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.CharField(choices=[('A', 'Almuerzo'), ('C', 'Cena'), ('P', 'Postre')], max_length=1, verbose_name='Tipo de planificacion')),
            ],
            options={
                'ordering': ['-created', 'modified'],
                'get_latest_by': 'created',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, unique=True, verbose_name='Nombre de la categoria')),
                ('comment', models.TextField(blank=True, max_length=500, verbose_name='Comentario de la categoria')),
                ('icon_svg', models.TextField(max_length=500, verbose_name='Codigo del icono')),
            ],
            options={
                'ordering': ['-created', 'modified'],
                'get_latest_by': 'created',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(blank=True, default=True, help_text='La fila esta activa o no', verbose_name='is active')),
                ('discount', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=19, verbose_name='Descuento del producto')),
                ('payment_method', models.CharField(blank=True, choices=[('D', 'Debito'), ('T', 'Credito'), ('T', 'Paypal')], default='C', max_length=1, verbose_name='Tipo de metodo de pago')),
                ...
                ('steps', models.CharField(blank=True, choices=[('R', 'Pedido recibido'), ('C', 'Realizando las compras'), ('P', 'Preparando el pedido'), ('CA', 'Pedido en camino'), ('E', 'Pedido entregado')], default='P', max_length=2, verbose_name='Seguimiento de la venta')),
