    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.BigIntegerField(verbose_name='Codigo del cupon')),
                ('discount', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=19, verbose_name='Descuento del cupon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=700, null=True, verbose_name='Comentario de la receta')),
            ],
            options={
                'ordering': ['-created', 'modified'],
                'get_latest_by': 'created',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True, help_text='Date Time de la ultima modificacion del objeto', verbose_name='modified at')),
                ('is_active', models.BooleanField(blank=True, default=True, help_text='La fila esta activa o no', verbose_name='is active')),
                ('payment_method', models.CharField(blank=True, choices=[('G', 'Gratis'), ('C', 'Contado'), ('D', 'Debito'), ('T', 'Credito')], default='C', max_length=1, verbose_name='Tipo de metodo de pago')),
                ('total', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=19, verbose_name='Total')),
                ...
                ('comment', models.TextField(blank=True, max_length=500, verbose_name='Comentario de la venta')),
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='foods.coupon')),
            ],
            options={
                'ordering': ['-created', 'modified'],
                'get_latest_by': 'created',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=19, verbose_name='Descuento del producto')),
                ('sub_total', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=19, verbose_name='Sub total')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True, help_text='Date Time de la ultima modificacion del objeto', verbose_name='modified at')),
                ('is_active', models.BooleanField(blank=True, default=True, help_text='La fila esta activa o no', verbose_name='is active')),
                ('label', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foods.label')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_total', models.DecimalField(decimal_places=2, default=0, max_digits=19, verbose_name='Sub total')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foods.product')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foods.recipe')),
            ],
            options={
